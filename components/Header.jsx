...
const Header = () => {
  ...
  <img src="banner.jpg" alt="" className="absolute inset-0 -z-10 size-full object-cover object-right md:object-center"></img>
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base/7 font-semibold text-white sm:grid-cols-2 md:flex lg:gap-x-10">
        <a href="/about">Our Services <span aria-hidden="true">&rarr;</span></a>
        <a href="/about">Our Mission<span aria-hidden="true">&rarr;</span></a>
        <a href="/about">Our values <span aria-hidden="true">&rarr;</span></a>
        <a href="#leadership">Meet our leadership <span aria-hidden="true">&rarr;</span></a>
      </div>
